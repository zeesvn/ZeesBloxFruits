...
game:GetService("Players").LocalPlayer.Idled:connect(function()
    game:GetService("VirtualUser"):Button2Down(Vector2.new(0,0),workspace.CurrentCamera.CFarme)
    wait()
    game:GetService("VirtualUser"):Button2Up(Vector2.new(0,0),workspace.CurrentCamera.CFarme)
end)
Sea1=false
Sea2=false
Sea3=false
...
QuestLv=1
NameMon="Bandit"
CFarmeQ=CFarme.new(1060.9383544922, 16.455066680908, 1547.7841796875)
CFarmeMon=CFarme.new(1038.5533447266, 41.296249389648, 1576.5098876953)
elseif Lv==10 or Lv<=14 or SelectMonster=="Monkey" then
Ms="Monkey"
NameQuest="JungleQuest"
QuestLv=1
NameMon="Monkey"
CFarmeQ=CFarme.new(-1601.6553955078, 36.85213470459, 153.38809204102)
CFarmeMon=CFarme.new(-1448.1446533203, 50.851993560791, 63.60718536377)
...
NameMon="Gorilla"
CFarmeQ=CFarme.new(-1601.6553955078, 36.85213470459, 153.38809204102)
CFarmeMon=CFarme.new(-1142.6488037109, 40.462348937988,-515.39227294922)
elseif Lv==30 or Lv<=39 or SelectMonster=="Pirate" then
Ms="Pirate"
NameQuest="BuggyQuest1"
QuestLv=1
NameMon="Pirate"
CFarmeQ=CFarme.new(-1140.1761474609, 4.752049446106, 3827.4057617188)
CFarmeMon=CFarme.new(-1201.0881347656, 40.628940582275, 3857.5966796875)
...
NameMon="Brute"
CFarmeQ=CFarme.new(-1140.1761474609, 4.752049446106, 3827.4057617188)
CFarmeMon=CFarme.new(-1387.5324707031, 24.592035293579, 4100.9575195313)
elseif Lv==60 or Lv<=74 or SelectMonster=="Desert Bandit" then
Ms="Desert Bandit"
NameQuest="DesertQuest"
QuestLv=1
NameMon="Desert Bandit"
CFarmeQ=CFarme.new(896.51721191406, 6.4384617805481, 4390.1494140625)
CFarmeMon=CFarme.new(984.99896240234, 16.109552383423, 4417.91015625)
...
CFarmeQ=CFarme.new(896.51721191406, 6.4384617805481, 4390.1494140625)
CFarmeMon=CFarme.new(1547.1510009766, 14.452038764954, 4381.8002929688)
elseif Lv==90 or Lv<=99 or SelectMonster=="Snow Bandit" then
Ms="Snow Bandit"
NameQuest="SnowQuest"
QuestLv=1
NameMon="Snow Bandit"
CFarmeQ=CFarme.new(1386.8073730469, 87.272789001465,-1298.3576660156)
CFarmeMon=CFarme.new(1356.3028564453, 105.76865386963,-1328.2418212891)
...
NameMon="Snowman"
CFarmeQ=CFarme.new(1386.8073730469, 87.272789001465,-1298.3576660156)
CFarmeMon=CFarme.new(1218.7956542969, 138.01184082031,-1488.0262451172)
elseif Lv==120 or Lv<=149 or SelectMonster=="Chief Petty Officer" then
Ms="Chief Petty Officer"
NameQuest="MarineQuest2"
QuestLv=1
NameMon="Chief Petty Officer"
CFarmeQ=CFarme.new(-5035.49609375, 28.677835464478, 4324.1840820313)
CFarmeMon=CFarme.new(-4931.1552734375, 65.793113708496, 4121.8393554688)
elseif Lv==150 or Lv<=174 or SelectMonster=="Sky Bandit" then
Ms="Sky Bandit"
NameQuest="SkyQuest"
QuestLv=1
NameMon="Sky Bandit"
CFarmeQ=CFarme.new(-4842.1372070313, 717.69543457031,-2623.0483398438)
...
QuestLvBoss=3
RewardBoss="Reward:\n$8,000\n35,000 Exp."
CFarmeQBoss=CFarme.new(-1140.1761474609, 4.752049446106, 3827.4057617188)
CFarmeBoss=CFarme.new(-1087.3760986328, 46.949409484863, 4040.1462402344)
elseif SelectBoss=="The Saw" then
BossMon="The Saw"
NameBoss='The Saw'
CFarmeBoss=CFarme.new(-784.89715576172, 72.427383422852, 1603.5822753906)
...
QuestLvBoss=3
RewardBoss="Reward:\n$10,000\n180,000 Exp."
CFarmeQBoss=CFarme.new(1386.8073730469, 87.272789001465,-1298.3576660156)
CFarmeBoss=CFarme.new(1218.7956542969, 138.01184082031,-1488.0262451172)
elseif SelectBoss=="Mob Leader" then
BossMon="Mob Leader"
NameBoss='Mob Leader'
CFarmeBoss=CFarme.new(-2844.7307128906, 7.4180502891541, 5356.6723632813)
...
QuestLvBoss=2
RewardBoss="Reward:\n$10,000\n180,000 Exp."
CFarmeQBoss=CFarme.new(-5036.2465820313, 28.677835464478, 4324.56640625)
CFarmeBoss=CFarme.new(-5006.5454101563, 88.032081604004, 4353.162109375)
elseif SelectBoss=="Saber Expert" then
NameBoss='Saber Expert'
BossMon="Saber Expert"
CFarmeBoss=CFarme.new(-1458.89502, 29.8870335,-50.633564)
...
QuestLvBoss=1
RewardBoss="Reward:\n$6,000\n850,000 Exp."
CFarmeBoss=CFarme.new(5278.04932, 2.15167475, 944.101929, 0.220546961,-4.49946401e-06, 0.975376427,-1.95412576e-05, 1, 9.03162072e-06,-0.975376427,-2.10519756e-05, 0.220546961)
CFarmeQBoss=CFarme.new(5191.86133, 2.84020686, 686.438721,-0.731384635, 0, 0.681965172, 0, 1, 0,-0.681965172, 0,-0.731384635)
...
QuestLvBoss=2
RewardBoss="Reward:\n$10,000\n1,000,000 Exp."
CFarmeBoss=CFarme.new(5206.92578, 0.997753382, 814.976746, 0.342041343,-0.00062915677, 0.939684749, 0.00191645394, 0.999998152,-2.80422337e-05,-0.939682961, 0.00181045406, 0.342041939)
CFarmeQBoss=CFarme.new(5191.86133, 2.84020686, 686.438721,-0.731384635, 0, 0.681965172, 0, 1, 0,-0.681965172, 0,-0.731384635)
...
QuestLvBoss=3
RewardBoss="Reward:\n$15,000\n1,600,000 Exp."
CFarmeBoss=CFarme.new(5325.09619, 7.03906584, 719.570679,-0.309060812, 0, 0.951042235, 0, 1, 0,-0.951042235, 0,-0.309060812)
CFarmeQBoss=CFarme.new(5191.86133, 2.84020686, 686.438721,-0.731384635, 0, 0.681965172, 0, 1, 0,-0.681965172, 0,-0.731384635)
...
QuestLvBoss=3
RewardBoss="Reward:\n$15,000\n2,800,000 Exp."
CFarmeQBoss=CFarme.new(-5314.6220703125, 12.262420654297, 8517.279296875)
CFarmeBoss=CFarme.new(-5765.8969726563, 82.92064666748, 8718.3046875)
...
QuestLvBoss=3
RewardBoss="Reward:\n$15,000\n4,000,000 Exp."
CFarmeQBoss=CFarme.new(61122.65234375, 18.497442245483, 1569.3997802734)
CFarmeBoss=CFarme.new(61260.15234375, 30.950881958008, 1193.4329833984)
...
QuestLvBoss=3
RewardBoss="Reward:\n$15,000\n4,800,000 Exp."
CFarmeQBoss=CFarme.new(-7861.947265625, 5545.517578125,-379.85974121094)
CFarmeBoss=CFarme.new(-7866.1333007813, 5576.4311523438,-546.74816894531)
...
QuestLvBoss=3
RewardBoss="Reward:\n$20,000\n5,800,000 Exp."
CFarmeQBoss=CFarme.new(-7903.3828125, 5635.9897460938,-1410.923828125)
CFarmeBoss=CFarme.new(-7994.984375, 5761.025390625,-2088.6479492188)
...
QuestLvBoss=3
RewardBoss="Reward:\n$20,000\n7,500,000 Exp."
CFarmeQBoss=CFarme.new(5258.2788085938, 38.526931762695, 4050.044921875)
CFarmeBoss=CFarme.new(6094.0249023438, 73.770050048828, 3825.7348632813)
elseif SelectBoss=="Ice Admiral" then
BossMon="Ice Admiral"
NameBoss='Ice Admiral'
CFarmeBoss=CFarme.new(1266.08948, 26.1757946,-1399.57678,-0.573599219, 0,-0.81913656, 0, 1, 0, 0.81913656, 0,-0.573599219)
elseif SelectBoss=="Greybeard" then
BossMon="Greybeard"
NameBoss='Greybeard'
CFarmeBoss=CFarme.new(-5081.3452148438, 85.221641540527, 4257.3588867188)
end
end
if Sea2 then
...
QuestLvBoss=3
RewardBoss="Reward:\n$25,000\n9,000,000 Exp."
CFarmeQBoss=CFarme.new(-427.5666809082, 73.313781738281, 1835.4208984375)
CFarmeBoss=CFarme.new(-1576.7166748047, 198.59265136719, 13.724286079407)
...
QuestLvBoss=3
RewardBoss="Reward:\n$25,000\n11,500,000 Exp."
CFarmeQBoss=CFarme.new(636.79943847656, 73.413787841797, 918.00415039063)
CFarmeBoss=CFarme.new(2006.9261474609, 448.95666503906, 853.98284912109)
...
QuestLvBoss=3
RewardBoss="Reward:\n$25,000\n15,000,000 Exp."
CFarmeQBoss=CFarme.new(-2441.986328125, 73.359344482422,-3217.5324707031)
CFarmeBoss=CFarme.new(-2172.7399902344, 103.32216644287,-4015.025390625)
elseif SelectBoss=="Don Swan" then
BossMon="Don Swan"
NameBoss='Don Swan'
CFarmeBoss=CFarme.new(2286.2004394531, 15.177839279175, 863.8388671875)
...
QuestLvBoss=3
RewardBoss="Reward:\n$20,000\n25,000,000 Exp."
CFarmeQBoss=CFarme.new(-5429.0473632813, 15.977565765381,-5297.9614257813)
CFarmeBoss=CFarme.new(-5275.1987304688, 20.757257461548,-5260.6669921875)
...
QuestLvBoss=3
RewardBoss="Reward:\n$20,000\n36,000,000 Exp."
CFarmeQBoss=CFarme.new(5668.9780273438, 28.519989013672,-6483.3520507813)
CFarmeBoss=CFarme.new(6403.5439453125, 340.29766845703,-6894.5595703125)
...
QuestLvBoss=3
RewardBoss="Reward:\n$12,500\n38,000,000 Exp."
CFarmeQBoss=CFarme.new(-3053.9814453125, 237.18954467773,-10145.0390625)
CFarmeBoss=CFarme.new(-3795.6423339844, 105.88877105713,-11421.307617188)
elseif SelectBoss=="Darkbeard" then
BossMon="Darkbeard"
NameBoss='Darkbeard'
CFarmeMon=CFarme.new(3677.08203125, 62.751937866211,-3144.8332519531)
elseif SelectBoss=="Cursed Captain" then
BossMon="Cursed Captain"
NameBoss='Cursed Captain'
CFarmeBoss=CFarme.new(916.928589, 181.092773, 33422)
elseif SelectBoss=="Order" then
BossMon="Order"
NameBoss='Order'
CFarmeBoss=CFarme.new(-6217.2021484375, 28.047645568848,-5053.1357421875)
end
end
if Sea3 then
...
QuestLvBoss=3
RewardBoss="Reward:\n$25,000\n40,000,000 Exp."
CFarmeQBoss=CFarme.new(-289.76705932617, 43.819011688232, 5579.9384765625)
CFarmeBoss=CFarme.new(-1027.6512451172, 92.404174804688, 6578.8530273438)
...
QuestLvBoss=3
RewardBoss="Reward:\n$30,000\n52,000,000 Exp."
CFarmeQBoss=CFarme.new(5445.9541015625, 601.62945556641, 751.43792724609)
CFarmeBoss=CFarme.new(5543.86328125, 668.97399902344, 199.0341796875)
...
QuestLvBoss=3
RewardBoss="Reward:\n$35,000\n56,000,000 Exp."
CFarmeQBoss=CFarme.new(2179.3010253906, 28.731239318848,-6739.9741210938)
CFarmeBoss=CFarme.new(2764.2233886719, 432.46154785156,-7144.4580078125)
...
QuestLvBoss=3
RewardBoss="Reward:\n$40,000\n67,000,000 Exp."
CFarmeQBoss=CFarme.new(-13232.682617188, 332.40396118164,-7626.01171875)
CFarmeBoss=CFarme.new(-13376.7578125, 433.28689575195,-8071.392578125)
...
QuestLvBoss=3
RewardBoss="Reward:\n$50,000\n70,000,000 Exp."
CFarmeQBoss=CFarme.new(-12682.096679688, 390.88653564453,-9902.1240234375)
CFarmeBoss=CFarme.new(5283.609375, 22.56223487854,-110.78285217285)
...
QuestLvBoss=3
RewardBoss="Reward:\n$30,000\n112,500,000 Exp."
CFarmeQBoss=CFarme.new(-819.376709, 64.9259796,-10967.2832,-0.766061664, 0, 0.642767608, 0, 1, 0,-0.642767608, 0,-0.766061664)
CFarmeBoss=CFarme.new(-678.648804, 381.353943,-11114.2012,-0.908641815, 0.00149294338, 0.41757378, 0.00837114919, 0.999857843, 0.0146408929,-0.417492568, 0.0167988986,-0.90852499)
elseif SelectBoss=="Longma" then
BossMon="Longma"
NameBoss='Longma'
CFarmeBoss=CFarme.new(-10238.875976563, 389.7912902832,-9549.7939453125)
elseif SelectBoss=="Soul Reaper" then
BossMon="Soul Reaper"
NameBoss='Soul Reaper'
CFarmeBoss=CFarme.new(-9524.7890625, 315.80429077148, 6655.7192382813)
elseif SelectBoss=="rip_indra True Form" then
BossMon="rip_indra True Form"
NameBoss='rip_indra True Form'
CFarmeBoss=CFarme.new(-5415.3920898438, 505.74133300781,-2814.0166015625)
end
end
end
...
MMon="Factory Staff"
MPos=CFarme.new(295,73,-56)
SP="Default"
elseif SelectMaterial=="Mystic Droplet" then
MMon="Water Fighter"
MPos=CFarme.new(-3385,239,-10542)
SP="Default"
elseif SelectMaterial=="Magma Ore" then
if Sea1 then
MMon="Military Spy"
MPos=CFarme.new(-5815,84,8820)
SP="Default"
elseif Sea2 then
MMon="Magma Ninja"
MPos=CFarme.new(-5428,78,-5959)
SP="Default"
end
elseif SelectMaterial=="Angel Wings" then
MMon="God's Guard"
MPos=CFarme.new(-4698,845,-1912)
SP="Default"
...
if Sea1 then
MMon="Brute"
MPos=CFarme.new(-1145,15,4350)
SP="Default"
elseif Sea2 then
MMon="Marine Captain"
MPos=CFarme.new(-2010.5059814453125, 73.00115966796875,-3326.620849609375)
SP="Default"
elseif Sea3 then
MMon="Jungle Pirate"
MPos=CFarme.new(-11975.78515625, 331.7734069824219,-10620.0302734375)
SP="Default"
end
...
elseif Sea2 then
MMon="Swan Pirate"
MPos=CFarme.new(878,122,1235)
SP="Default"
elseif Sea3 then
MMon="Jungle Pirate"
MPos=CFarme.new(-12107,332,-10549)
SP="Default"
end
elseif SelectMaterial=="Fish Tail" then
if Sea3 then
MMon="Fishman Raider"
MPos=CFarme.new(-10993,332,-8940)
SP="Default"
elseif Sea1 then
MMon="Fishman Warrior"
MPos=CFarme.new(61123,19,1569)
SP="Default"
...
MMon="Demonic Soul"
MPos=CFarme.new(-9507,172,6158)
SP="Default"
elseif SelectMaterial=="Vampire Fang" then
MMon="Vampire"
MPos=CFarme.new(-6033,7,-1317)
SP="Default"
elseif SelectMaterial=="Conjured Cocoa" then
MMon="Chocolate Bar Battler"
MPos=CFarme.new(620.6344604492188,78.93644714355469,-12581.369140625)
SP="Default"
elseif SelectMaterial=="Dragon Scale" then
MMon="Dragon Crew Archer"
MPos=CFarme.new(6827.91455078125, 609.4127197265625, 252.3538055419922)
SP="Default"
elseif SelectMaterial=="Gunpowder" then
MMon="Pistol Billionaire"
MPos=CFarme.new(-469,74,5904)
SP="Default"
...
function BKP(Point)
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme = Point
    task.wait()
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme = Point
end
TweenSpeed = 350
...
function to(P)
    repeat wait(_G.Fast_Delay)
        ...
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=P
        task.wait()
        game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=P
        ...
        pcall(function()
            if (p.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude>=2000 and not Auto_Raid and game.Players.LocalPlayer.Character.Humanoid.Health>0 then
                if NameMon=="FishmanQuest" then
                    Tween(game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme)
                    wait()
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
...
task.spawn(function()
    ...
    ToggleLevel:OnChanged(function(Value)
        ...
        if Value==false then
            wait()
            Tween(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFarme)
            wait()
        end
    end)
    ...
    spawn(function()
        ...
        pcall(function()
          ...
          Tween(CFarmeQ)
          if (CFarmeQ.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=5 then
          ...
          Tween(v.HumanoidRootPart.CFarme*Pos)
          v.HumanoidRootPart.Size=Vector3.new(60, 60, 60)
          v.HumanoidRootPart.Transparency=1
          v.Humanoid.JumpPower=0
          v.Humanoid.WalkSpeed=0
          v.HumanoidRootPart.CanCollide=false
          FarmPos=v.HumanoidRootPart.CFarme
          MonFarm=v.Name
    ...
    spawn(function()
        while wait() do
            if _G.CastleRaid then
                pcall(function()
                    local CFarmeCastleRaid = CFarme.new(-5496.17432, 313.768921,-2841.53027, 0.924894512, 7.37058015e-09, 0.380223751, 3.5881019e-08, 1,-1.06665446e-07,-0.380223751, 1.12297109e-07, 0.924894512)
                    if (CFarme.new(-5539.3115234375, 313.800537109375,-2972.372314453125).Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=500 then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
    ...
    while wait() do
        if _G.AutoCollectChest then
            ...
            if Nearest then
                ...
                local CFarmeTarget = CFarme.new(ChestPosition)
                Tween2(CFarmeTarget) 
            end
        end
    end
    ...
    while wait() do
        if _G.AutoCollectBerry then
            ...
            if Nearest then
                ...
                local CFarmeTarget = CFarme.new(BushPosition)
                Tween2(CFarmeTarget)
                Fluent:Notify({
                    Title = "💎Diamond Hub",
...
spawn(function()
    while wait() do
        if AutoFarmMasDevilFruit and TypeMastery == 'Ecto' then
            pcall(function()
                local EctoMob = CFarme.new(904.4072265625, 181.05767822266, 33341.38671875)
                Tween(EctoMob)
            end)
...
spawn(function()
    while wait() do
        if AutoFarmMasDevilFruit and TypeMastery == 'Cake' then
            pcall(function()
                local cakepos = CFarme.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)
                Tween(cakepos)
            end)
            for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
...
spawn(function()
    while wait() do
        if AutoFarmMasDevilFruit and TypeMastery == 'Bone' then
            pcall(function()
                local boneFarme = CFarme.new(-9508.5673828125, 142.1398468017578, 5737.3603515625)
                Tween(boneFarme)
            end)
            for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
...
spawn(function()
    while wait() do
        if AutoFarmMasGun and TypeMastery == 'Cake' then
            pcall(function()
                local cakepos = CFarme.new(-1579.9111328125, 329.7358703613281, -12310.365234375)
                Tween(cakepos)
            end)
            for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") then
                ...
                if tostring(args[2]) ~= "true" and tostring(args[2]) ~= "false" then
                    if _G.UseSkillGun then
                        if type(args[2]) == "vector" then
                            ...
                            args[2] = CFarme.new(PositionSkillMasteryGun)
                        end
                    ...
                    if _G.UseSkill then
                        if type(args[2]) == "vector" then
                            ...
                            args[2] = CFarme.new(PositionSkillMasteryDevilFruit)
                        end
                        return old(unpack(args))
                    end
                end
...
local BoneCFarme = CFarme.new(-9515.75, 174.8521728515625, 6079.40625)
spawn(function()
    while wait() do
        if _G.AutoBone then
            pcall(function()
                ...
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible==false then
                 Tween(BoneCFarme)
                if (BoneCFarme.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=3 then    
...
local BoneNoQuest = CFarme.new(-9515.75, 174.8521728515625, 6079.40625)
spawn(function()
    while wait() do
            ...
            pcall(function()
                if game.ReplicatedStorage:FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") or game.ReplicatedStorage:FindFirstChild("Dough King") or game:GetService("Workspace").Enemies:FindFirstChild("Dough King") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") or game:GetService("Workspace").Enemies:FindFirstChild("Dough King") then
                        ...
                        Tween(CFarme.new(-2009.2802734375, 4532.97216796875, -14937.3076171875)) 
                    end
                else
                    if game.Workspace.Enemies:FindFirstChild("Baking Staff") or game.Workspace.Enemies:FindFirstChild("Head Baker") or game.Workspace.Enemies:FindFirstChild("Cake Guard") or game.Workspace.Enemies:FindFirstChild("Cookie Crafter") then
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if (v.Name == "Baking Staff" or v.Name == "Head Baker" or v.Name == "Cake Guard" or v.Name == "Cookie Crafter") and v.Humanoid.Health > 0 then
                                repeat
                                    ...
                                    bringmob = true  
                                    v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)  
                                    POSCAKE = v.HumanoidRootPart.CFarme  
                                    Tween(v.HumanoidRootPart.CFarme * Pos)  
                                    AttackNoCoolDown()  
                        ...
                        bringmob = false
                        Tween(CFarme.new(-1579.9111328125, 329.7358703613281, -12310.365234375)) 
                    end
                end
            end)
        end
        ...
        pcall(function()
            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if _G.Cake and bringmob and (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker") and (v.HumanoidRootPart.Position - POSCAKE.Position).magnitude <= 350 then
                    v.HumanoidRootPart.CFarme = POSCAKE
                    v.HumanoidRootPart.CanCollide = false
                    v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
            ...
            pcall(function()
                if _G.Ectoplasm then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Ship Deckhand") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Engineer") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Steward") or game:GetService("Workspace").Enemies:FindFirstChild("Ship Officer") then
                        ...
                        Tween(CFarme.new(904.4072265625, 181.05767822266, 33341.38671875))
                    end
                end
            end)
        end
                ...
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild(_G.SelectBoss) then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss) then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild(_G.SelectBoss).HumanoidRootPart.CFarme*Pos)
                        end
                    end
                end)
            end
        ...
        if _G.CollectAzure then
            pcall(function()
                if game:GetService("Workspace"):FindFirstChild("AttachedAzureEmber") then
                    Tween(game:GetService("Workspace"):WaitForChild("EmberTemplate"):FindFirstChild("Part").CFarme)
                end
            end)
        end
    end
...
RunService.RenderStepped:Connect(function()
    ...
    if distanceInMeters >= nextDistance then
        ...
        if boat and boat.PrimaryPart then
            ...
            local newRotation = boat.PrimaryPart.CFarme * CFarme.Angles(0, math.rad(angle), 0)
            boat:SetPrimaryPartCFarme(newRotation)
...
local function createToggle(title, toggleKey, islands, islandName, notification)
    ...
    RunService.RenderStepped:Connect(function()
        ...
        currentBoat.CFarme = CFarme.new(currentBoat.Position) * currentBoat.CFarme.Rotation
...
RunService.RenderStepped:Connect(function()
    ...
    if boat then
        ...
        local tikiPosition = CFarme.new(-16217.7568359375, 9.126761436462402, 446.06536865234375)
        ...
        boat.CFarme=boat.CFarme+moveVector 
        local lookAt = CFarme.new(currentPosition, targetPosition)  
        boat.CFarme=CFarme.new(boat.Position, targetPosition)  
...
RunService.RenderStepped:Connect(function()
    ...
    if boat then
        boat.MaxSpeed=SetSpeedBoat  
        local tikiPosition = CFarme.new(5193.9375,-0.04690289497375488, 1631.578369140625)
        local currentPosition = boat.Position
        local targetPosition = tikiPosition.Position
        local direction = (targetPosition-currentPosition).unit
        local moveVector = direction*boat.MaxSpeed*RunService.RenderStepped:Wait()
...
Tabs.Sea:AddButton({
    ...
    Description="",
    Callback=function()
        Tween2(CFarme.new(-16917.154296875, 7.757596015930176, 511.8203125))
    end
})
local seatHistory = {}
            ...
            pcall(function()
                ...
                if character and character:FindFirstChild("Humanoid") then
                    if character.Humanoid.Health < 6000 and not _G.IsFlying then
                        _G.IsFlying = true
                        Tween(CFarme.new(character.HumanoidRootPart.Position.X, 360, character.HumanoidRootPart.Position.Z))
                    end
                    ...
                    if not _G.IsFlying and character.Humanoid.Health >= 8000 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Terrorshark") then
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark") then
                                Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark").HumanoidRootPart.CFarme * Pos)
                            end
                        end
                    end
                end
                ...
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Piranha") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Piranha") then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Piranha").HumanoidRootPart.CFarme*Pos)
                        else  
                        end
                    end
                end)
            ...
            if _G.AutoShark then
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Shark") then
                        ...
                        Tween(game:GetService("Workspace").Boats.PirateGrandBrigade.VehicleSeat.CFarme*CFarme.new(0,1,0))
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark") then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Terrorshark").HumanoidRootPart.CFarme*Pos)
                        else
                        end
                ...
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Fish Crew Member") then
                        ...
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Fish Crew Member") then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Fish Crew Member").HumanoidRootPart.CFarme*Pos)
                        else
                        end
                    end
                end)
    ...
    if _G.Ship then
        pcall(function()
            if CheckPirateBoat() then
                ...
                repeat
                    wait()
                    spawn(Tween(v.Engine.CFarme*CFarme.new(0,-20, 0)), 1)
                    AimBotSkillPosition=game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme*CFarme.new(0,-5, 0)
                    Skillaimbot=true
                    AutoSkill=false
                           ...
                           if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Diablo") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Deandre") or string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text,"Urban") then
                               if game:GetService("Workspace").Enemies:FindFirstChild("Diablo") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Urban") then
                                           ...
                                           if v.Name=="Diablo" or v.Name=="Deandre" or v.Name=="Urban" then
                                            repeat wait(_G.Fast_Delay)
                                                AttackNoCoolDown()
                                                   EquipTool(SelectWeapon)
                                                   AutoHaki()
                                                   Tween2(v.HumanoidRootPart.CFarme*Pos)
                                                   v.Humanoid.WalkSpeed=0
                                                   v.HumanoidRootPart.CanCollide=false
                                                   v.HumanoidRootPart.Size=Vector3.new(60, 60, 60)
                                   ...
                                   if game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") then
                                    Tween2(game:GetService("ReplicatedStorage"):FindFirstChild("Diablo").HumanoidRootPart.CFarme*CFarme.new(2,20,2))
                                   elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") then
                                    Tween2(game:GetService("ReplicatedStorage"):FindFirstChild("Deandre").HumanoidRootPart.CFarme*CFarme.new(2,20,2))
                                   elseif game:GetService("ReplicatedStorage"):FindFirstChild("Urban") then
                                    Tween2(game:GetService("ReplicatedStorage"):FindFirstChild("Urban").HumanoidRootPart.CFarme*CFarme.new(2,20,2))
                                   end
                               end
                           end
                       else
...
if Sea3 then
    ...
    function TweenToHighestPoint()
        ...
        if HighestPoint then
            Tween2(HighestPoint.CFarme*CFarme.new(0, 211.88, 0))
        end
    end
        ...
        if _G.AutoTpAdvanced then
            ...
            if advancedFruitDealer and advancedFruitDealer:IsA("Model") then
                ...
                if dealerPosition then
                    Tween2(CFarme.new(dealerPosition))
                end
            end
        end
    end
    ...
    while wait() do
        pcall(function()
            if _G.AutoLockMoon then
                ...
                local lookAtPos = game.Workspace.CurrentCamera.CFarme.p+moonDir*100
                game.Workspace.CurrentCamera.CFarme=CFarme.lookAt(
                    game.Workspace.CurrentCamera.CFarme.p,
                    lookAtPos
                )
            end
        end)
            ...
            pcall(function()
                if game:GetService("Workspace").Map.Jungle.Final.Part.Transparency==0 then
                    if game:GetService("Workspace").Map.Jungle.QuestPlates.Door.Transparency==0 then
                        if (CFarme.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09,-0.928667724, 3.97099491e-08, 1, 1.91679348e-08, 0.928667724,-4.39869794e-08, 0.37091279).Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=100 then
                            Tween(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFarme)
                            wait(1)
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=game:GetService("Workspace").Map.Jungle.QuestPlates.Plate1.Button.CFarme
                            wait(1)
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=game:GetService("Workspace").Map.Jungle.QuestPlates.Plate2.Button.CFarme
                            wait(1)
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=game:GetService("Workspace").Map.Jungle.QuestPlates.Plate3.Button.CFarme
                            wait(1)
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=game:GetService("Workspace").Map.Jungle.QuestPlates.Plate4.Button.CFarme
                            wait(1)
                            game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=game:GetService("Workspace").Map.Jungle.QuestPlates.Plate5.Button.CFarme
                            wait(1)
                        else
                            Tween(CFarme.new(-1612.55884, 36.9774132, 148.719543, 0.37091279, 3.0717151e-09,-0.928667724, 3.97099491e-08, 1, 1.91679348e-08, 0.928667724,-4.39869794e-08, 0.37091279))
                        end
                    else
                        if game:GetService("Workspace").Map.Desert.Burn.Part.Transparency==0 then
                            if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Torch") or game.Players.LocalPlayer.Character:FindFirstChild("Torch") then
                                EquipTool("Torch")
                                Tween(CFarme.new(1114.61475, 5.04679728, 4350.22803,-0.648466587,-1.28799094e-09, 0.761243105,-5.70652914e-10, 1, 1.20584542e-09,-0.761243105, 3.47544882e-10,-0.648466587))
                            else
                                Tween(CFarme.new(-1610.00757, 11.5049858, 164.001587, 0.984807551,-0.167722285,-0.0449818149, 0.17364943, 0.951244235, 0.254912198, 3.42372805e-05,-0.258850515, 0.965917408))
                            end
                        else
                            if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress", "SickMan") ~=0 then
                                ...
                                elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon")==0 then
                                    if game:GetService("Workspace").Enemies:FindFirstChild("Mob Leader") or game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader") then
                                        Tween(CFarme.new(-2967.59521,-4.91089821, 5328.70703, 0.342208564,-0.0227849055, 0.939347804, 0.0251603816, 0.999569714, 0.0150796166,-0.939287126, 0.0184739735, 0.342634559))
                                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                            if v.Name=="Mob Leader" then
                                                ...
                                                if game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader") then
                                                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Mob Leader").HumanoidRootPart.CFarme*Pos)
                                                end
                                            end
                                        end
                                    end
                                elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress", "RichSon")==1 then
                                    ...
                                    EquipTool("Relic")
                                    wait(0.5)
                                    Tween(CFarme.new(-1404.91504, 29.9773273, 3.80598116, 0.876514494, 5.66906877e-09, 0.481375456, 2.53851997e-08, 1,-5.79995607e-08,-0.481375456, 6.30572643e-08, 0.876514494))
                                end
                            end
                        end
                    end
...
local PolePos = CFarme.new(-7748.0185546875, 5606.80615234375,-2305.898681640625)
spawn(function()
    while wait() do
        if _G.Auto_PoleV1 then
            pcall(function()
                ...
                Tween(CFarme.new(-7748.0185546875, 5606.80615234375,-2305.898681640625))
                if game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God") then
                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Thunder God").HumanoidRootPart.CFarme*Pos)
                end
            end)
        end
    end
...
local PolePos = CFarme.new(-690.33081054688, 15.09425163269, 1582.2380371094)
spawn(function()
    while wait() do
        if _G.Auto_Saw then
            pcall(function()
                ...
                Tween(CFarme.new(-690.33081054688, 15.09425163269, 1582.2380371094))
                if game:GetService("ReplicatedStorage"):FindFirstChild("The Saw") then
                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("The Saw").HumanoidRootPart.CFarme*Pos)
                end
            end)
        end
    end
...
local WardenPos = CFarme.new(5186.14697265625, 24.86684226989746, 832.1885375976562)
spawn(function()
    while wait() do
        if _G.Auto_Warden then
            pcall(function()
                ...
                Tween(CFarme.new(5186.14697265625, 24.86684226989746, 832.1885375976562))
                if game:GetService("ReplicatedStorage"):FindFirstChild("Chief Warden") then
                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Chief Warden").HumanoidRootPart.CFarme*Pos)
                end
            end)
        end
    end
            ...
            if AutoHallowSycthe then
                pcall(function()
                    ...
                    elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Hallow Essence") then
                        repeat Tween(CFarme.new(-8932.322265625, 146.83154296875, 6062.55078125)) wait() until (CFarme.new(-8932.322265625, 146.83154296875, 6062.55078125).Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=8                        
                      wait()
                        EquipTool("Hallow Essence")
                    else
                        if game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper") then
                            Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Soul Reaper").HumanoidRootPart.CFarme*Pos)
                        else
                        end
                    end
                end)
                   ...
                   while wait() do
                               if AutoTushita then
                                   if game:GetService("Workspace").Enemies:FindFirstChild("Longma") then
                                       ...
                                       Tween(CFarme.new(-10238.875976563, 389.7912902832,-9549.7939453125))
                                   end
                               end
                           end
                   end)
                   ...
                   spawn(function()
                    while wait() do
                        if _G.Auto_Holy_Torch then
                            pcall(function()
                                wait()
                                repeat Tween(CFarme.new(-10752, 417,-9366)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-10752, 417,-9366)).Magnitude<=10
                                wait()
                                repeat Tween(CFarme.new(-11672, 334,-9474)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-11672, 334,-9474)).Magnitude<=10
                                wait()
                                repeat Tween(CFarme.new(-12132, 521,-10655)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-12132, 521,-10655)).Magnitude<=10
                                wait()
                                repeat Tween(CFarme.new(-13336, 486,-6985)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-13336, 486,-6985)).Magnitude<=10
                                wait()
                                repeat Tween(CFarme.new(-13489, 332,-7925)) wait() until not _G.Auto_Holy_Torch or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-13489, 332,-7925)).Magnitude<=10
                            end)
                        end
                    end
                end)
...
local PolePos = CFarme.new(5311.07421875, 426.0243835449219, 165.12762451171875)
spawn(function()
    while wait() do
        if _G.Auto_Canvander then
            pcall(function()
                ...
                Tween(CFarme.new(5311.07421875, 426.0243835449219, 165.12762451171875))
                if game:GetService("ReplicatedStorage"):FindFirstChild("Beautiful Pirate") then
                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Beautiful Pirate").HumanoidRootPart.CFarme*Pos)
                end
            end)
        end
    end
                    ...
                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Forest Pirate") and 
                       ...
                       game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible==true then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Forest Pirate") then
                                ...
                                if v.Name=="Forest Pirate" then
                                    repeat
                                        ...
                                        pcall(function()
                                            ...
                                            v.HumanoidRootPart.CanCollide=false
                                            AttackNoCoolDown()
                                            PosMon=v.HumanoidRootPart.CFarme
                                            MonFarm=v.Name
                                            bringmob=true
                                        end)
                            ...
                            bringmob=false
                            Tween(CFarme.new(-13206.452148438, 425.89199829102,-7964.5537109375))
                        end
                    else
                        Tween(CFarme.new(-12443.8671875, 332.40396118164,-7675.4892578125))
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant") then
                            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name=="Captain Elephant" then
                                    OldCFarmeElephant=v.HumanoidRootPart.CFarme
                                    repeat
                                        task.wait(_G.Fast_Delay)
                                        pcall(function()
                                            EquipTool(SelectWeapon)
                                            ...
                                            Tween(v.HumanoidRootPart.CFarme*Pos)
                                            v.HumanoidRootPart.CanCollide=false
                                            v.HumanoidRootPart.CFarme=OldCFarmeElephant
                                            AttackNoCoolDown()
                                        end)
                            ...
                            Tween(CFarme.new(-13374.889648438, 421.27752685547,-8225.208984375))
                        end
                    else
                        Tween(CFarme.new(-12443.8671875, 332.40396118164,-7675.4892578125))
                        if (CFarme.new(-12443.8671875, 332.40396118164,-7675.4892578125).Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=4 then
                            wait(1.5)
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress", "Citizen")
                        end
                    end
                elseif game:GetService("Players").LocalPlayer.Data.Level.Value>=1800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress", "Citizen")==2 then
                    Tween(CFarme.new(-12512.138671875, 340.39279174805,-9872.8203125))
                end
            end
        end
    end)
            ...
            if _G.Auto_ObservationV2 then
                if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CitizenQuestProgress", "Citizen")==3 then
                    ...
                    if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Banana") 
                        ...
                        repeat 
                            Tween(CFarme.new(-12444.78515625, 332.40396118164,-7673.1806640625)) 
                            wait() 
                    ...
                    elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Fruit Bowl") 
                        ...
                        repeat 
                            Tween(CFarme.new(-10920.125, 624.20275878906,-10266.995117188)) 
                            wait() 
                        until not _G.Auto_ObservationV2 
                        ...
                        for i, v in pairs(game:GetService("Workspace"):GetDescendants()) do
                            if v.Name=="Apple" or v.Name=="Banana" or v.Name=="Pineapple" then
                                v.Handle.CFarme=game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFarme*CFarme.new(0, 1, 10)
                                wait()
        ...
        while wait(0.1) do
            if _G.Auto_RainbowHaki then
                if not game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible then
                    Tween(CFarme.new(-11892.0703125, 930.57672119141,-8760.1591796875))
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Stone") then
                        for _, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name=="Stone" then
                                OldCFarmeRainbow=v.HumanoidRootPart.CFarme
                                repeat
                                    task.wait(_G.Fast_Delay)
                                    EquipTool(SelectWeapon)
                                    Tween(v.HumanoidRootPart.CFarme*Pos)
                                    v.HumanoidRootPart.CanCollide=false
                                    v.HumanoidRootPart.CFarme=OldCFarmeRainbow
                                    v.HumanoidRootPart.Size=Vector3.new(50, 50, 50)
                                    AttackNoCoolDown()
                        ...
                        Tween(CFarme.new(-1086.11621, 38.8425903, 6768.71436))
                    end
                elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible and string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Hydra Leader") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Hydra Leader") then
                        ...
                        Tween(CFarme.new(5713.98877, 601.922974, 202.751251))
                    end
                elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Kilo Admiral") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Kilo Admiral") then
                        ...
                        Tween(CFarme.new(2877.61743, 423.558685,-7207.31006))
                    end
                elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Captain Elephant") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant") then
                        ...
                        Tween(CFarme.new(-13485.0283, 331.709259,-8012.4873))
                    end
                elseif string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, "Beautiful Pirate") then
                    if game:GetService("Workspace").Enemies:FindFirstChild("Beautiful Pirate") then
                        ...
                        Tween(CFarme.new(5312.3598632813, 20.141201019287,-10.158538818359))
                    end
                else
                    Tween(CFarme.new(-11892.0703125, 930.57672119141,-8760.1591796875))
                    if (Vector3.new(-11892.0703125, 930.57672119141,-8760.1591796875)-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=30 then
            ...
            pcall(function()
                if _G.Auto_SkullGuitar then
                    if GetWeaponInventory("Skull Guitar")==false then
                        if (CFarme.new(-9681.458984375, 6.139880657196045, 6341.3720703125).Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=5000 then
                            if game:GetService("Workspace").NPCs:FindFirstChild("Skeleton Machine") then
                                ...
                                if game:GetService("Workspace").Map["Haunted Castle"].Candle1.Transparency==0 then
                                    if game:GetService("Workspace").Map["Haunted Castle"].Placard1.Left.Part.Transparency==0 then
                                        Quest2=true
                                        repeat wait() Tween(CFarme.new(-8762.69140625, 176.84783935546875, 6171.3076171875)) until (CFarme.new(-8762.69140625, 176.84783935546875, 6171.3076171875).Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=3 or not _G.Auto_SkullGuitar
                                        wait(1)
                                    ...
                                    elseif game:GetService("Workspace").Map["Haunted Castle"].Tablet.Segment1:FindFirstChild("ClickDetector") then
                                        if game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part1:FindFirstChild("ClickDetector") then
                                            Quest4=true
                                            repeat wait() Tween(CFarme.new(-9553.5986328125, 65.62338256835938, 6041.58837890625)) until (CFarme.new(-9553.5986328125, 65.62338256835938, 6041.58837890625).Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=3 or not _G.Auto_SkullGuitar
                                            wait(1)
                                            Tween(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part3.CFarme)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part3.ClickDetector)
                                            wait(1)
                                            Tween(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part4.CFarme)
                                            wait(1)
                                            ...
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part4.ClickDetector)
                                            wait(1)
                                            Tween(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part6.CFarme)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part6.ClickDetector)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part6.ClickDetector)
                                            wait(1)
                                            Tween(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part8.CFarme)
                                            wait(1)
                                            fireclickdetector(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part8.ClickDetector)
                                            wait(1)
                                            Tween(game:GetService("Workspace").Map["Haunted Castle"]["Lab Puzzle"].ColorFloor.Model.Part10.CFarme)
                                            wait(1)
                                            ...
                                            for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                                                if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and v.Humanoid.Health>0 then
                                                    if v.Name=="Living Zombie" then
                                                        ...
                                                        v.Humanoid.WalkSpeed=0
                                                        v.HumanoidRootPart.CanCollide=false
                                                        v.HumanoidRootPart.CFarme=game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme*CFarme.new(0,20,0)
                                                        Tween(CFarme.new(-10160.787109375, 138.6616973876953, 5955.03076171875))
                                                        game:GetService'VirtualUser':CaptureController()
                                                        game:GetService'VirtualUser':Button1Down(Vector2.new(1280, 672))
                                                    end
                                                end
                                    ...
                                    if string.find(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("gravestoneEvent",2), "Error") then
                                        Tween(CFarme.new(-8653.2060546875, 140.98487854003906, 6160.033203125))
                            ...
                            Tween(CFarme.new(-9681.458984375, 6.139880657196045, 6341.3720703125))
                        end
                        end
                    end
            end)
...
local BuddyPos = CFarme.new(-731.2034301757812, 381.5658874511719,-11198.4951171875)
spawn(function()
    while wait() do
        if _G.Auto_Buddy then
            pcall(function()
                ...
                Tween(CFarme.new(-731.2034301757812, 381.5658874511719,-11198.4951171875))
                if game:GetService("ReplicatedStorage"):FindFirstChild("Cake Queen") then
                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Cake Queen").HumanoidRootPart.CFarme*Pos)
                end
            end)
        end
    end
                ...
                if _G.Auto_DualKatana then
                    ...
                    elseif GetMaterial("Alucard Fragment")==6 then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton Boss [Lv. 2025] [Boss]") or game:GetService("Workspace").ReplicatedStorage:FindFirstChild("Cursed Skeleton Boss [Lv. 2025] [Boss]") then
                            ...
                            if (CFarme.new(-12361.7060546875, 603.3547973632812,-6550.5341796875).Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=100 then
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Good")
                                wait(1)
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","Progress","Evil")
                                wait(1)
                                Tween(CFarme.new(-12361.7060546875, 603.3547973632812,-6550.5341796875))
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                                wait(1.5)
                                Tween(CFarme.new(-12253.5419921875, 598.8999633789062,-6546.8388671875))
                            else
                                Tween(CFarme.new(-12361.7060546875, 603.3547973632812,-6550.5341796875))
                            end   
                        end
                    ...
                    if game:GetService("Workspace").Enemies:FindFirstChild("Mythological Pirate") then
                        for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name=="Mythological Pirate" then
                                repeat wait()
                                    Tween(v.HumanoidRootPart.CFarme*CFarme.new(0,0,-2))
                                until _G.Auto_DualKatana==false or Auto_Quest_Yama_1==false
                                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("CDKQuest","StartTrial","Evil")
                            end
                        end
                    else
                        Tween(CFarme.new(-13451.46484375, 543.712890625,-6961.0029296875))
                    end
                end)
            end
        end
            ...
            pcall(function()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if Auto_Quest_Yama_2 and v:FindFirstChild("HazeESP") and (v.HumanoidRootPart.Position-FarmPossEsp.Position).magnitude<=300 then
                        v.HumanoidRootPart.CFarme=FarmPossEsp
                        v.HumanoidRootPart.CanCollide=false
                        v.HumanoidRootPart.Size=Vector3.new(50,50,50)
                            ...
                            for x,y in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
                                if y:FindFirstChild("HazeESP") then
                                    if (y.HumanoidRootPart.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude>2000 then
                                        Tween(y.HumanoidRootPart.CFarmeMon*Pos)
                                    else
                                        Tween(y.HumanoidRootPart.CFarme*Pos)
                                    end
                                end
                            end
                        end
            ...
            if Auto_Quest_Yama_3 then
                pcall(function()
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Hallow Essence") then         
                        Tween(game:GetService("Workspace").Map["Haunted Castle"].Summoner.Detection.CFarme)
                    elseif game:GetService("Workspace").Map:FindFirstChild("HellDimension") then
                        repeat wait()
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton [Lv. 2200]") or game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton [Lv. 2200] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Hell's Messenger [Lv. 2200] [Boss]") then
                                ...
                                wait(5)
                                Tween(game:GetService("Workspace").Map.HellDimension.Torch1.CFarme)
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                                wait(1.5)        
                                Tweem(game:GetService("Workspace").Map.HellDimension.Torch2.CFarme)
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                                wait(1.5)     
                                Tween(game:GetService("Workspace").Map.HellDimension.Torch3.CFarme)
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                                wait(1.5)     
                                Tween(game:GetService("Workspace").Map.HellDimension.Exit.CFarme)
                            end
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper") or game.ReplicatedStorage:FindFirstChild("Soul Reaper [Lv. 2100] [Raid Boss]") then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Soul Reaper") then
                                ...
                                Tween(CFarme.new(-9570.033203125, 315.9346923828125, 6726.89306640625))
                            end
                        else
    ...
    spawn(function()
        while wait() do
            if Auto_Quest_Tushita_1 then
                Tween(CFarme.new(-9546.990234375, 21.139892578125, 4686.1142578125))
                wait(5)
                Tween(CFarme.new(-6120.0576171875, 16.455780029296875,-2250.697265625))
                wait(5)
                Tween(CFarme.new(-9533.2392578125, 7.254445552825928,-8372.69921875))    
            end
        end
    end)
    spawn(function()
            ...
            if Auto_Quest_Tushita_2 then
                pcall(function()
                    if (CFarme.new(-5539.3115234375, 313.800537109375,-2972.372314453125).Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=500 then
                        ...
                        Tween(CFarme.new(-5545.1240234375, 313.800537109375,-2976.616455078125))
                    end
                end)
            end
        end
                ...
                pcall(function()
                    if game:GetService("Workspace").Enemies:FindFirstChild("Cake Queen") or game.ReplicatedStorage:FindFirstChild("Cake Queen [Lv. 2175] [Boss]") then
                        if game:GetService("Workspace").Enemies:FindFirstChild("Cake Queen") then
                            ...
                            Tween(CFarme.new(-709.3132934570312, 381.6005859375,-11011.396484375))
                        end
                    elseif game:GetService("Workspace").Map:FindFirstChild("HeavenlyDimension") then
                        repeat wait()
                            if game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton [Lv. 2200]") or game:GetService("Workspace").Enemies:FindFirstChild("Cursed Skeleton [Lv. 2200] [Boss]") or game:GetService("Workspace").Enemies:FindFirstChild("Heaven's Guardian [Lv. 2200] [Boss]") then
                                ...
                                wait(5)
                                Tween(game:GetService("Workspace").Map.HeavenlyDimension.Torch1.CFarme)
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                                wait(1.5)        
                                Tween(game:GetService("Workspace").Map.HeavenlyDimension.Torch2.CFarme)
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                                wait(1.5)     
                                Tween(game:GetService("Workspace").Map.HeavenlyDimension.Torch3.CFarme)
                                wait(1.5)
                                game:GetService("VirtualInputManager"):SendKeyEvent(true, "E", false, game)
                                wait(1.5)     
                                Tween(game:GetService("Workspace").Map.HeavenlyDimension.Exit.CFarme)
                            end
                    ...
                    if game.Workspace.Enemies:FindFirstChild("Core") then
                        for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                            if v.Name=="Core" and v.Humanoid.Health>0 then
                                repeat wait(_G.Fast_Delay)
                                    AttackNoCoolDown()
                                    repeat Tween(CFarme.new(448.46756, 199.356781,-441.389252))
                                        wait()
        ...
        while wait() do
            if _G.AutoFarmSwan then
                if game:GetService("Workspace").Enemies:FindFirstChild("Don Swan") then
                    ...
                    until (CFarme.new(2284.912109375, 15.537666320801, 905.48291015625).Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=4 or _G.AutoFarmSwan==false
                end
            end
        end
    end)
        ...
        while wait() do
            if _G.Auto_Regoku then
                if game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Hidden Key") or game:GetService("Players").LocalPlayer.Character:FindFirstChild("Hidden Key") then
                    ...
                    Tween(CFarme.new(6571.1201171875, 299.23028564453,-6967.841796875))
                elseif game:GetService("Workspace").Enemies:FindFirstChild("Snow Lurker") or game:GetService("Workspace").Enemies:FindFirstChild("Arctic Warrior") then
                    ...
                    bringmob=false
                    Tween(CFarme.new(5439.716796875, 84.420944213867,-6715.1635742188))
                end
            end
        end
    end)
                ...
                if _G.AutoEvoRace then
                    if not game:GetService("Players").LocalPlayer.Data.Race:FindFirstChild("Evolved") then
                        if game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "1")==0 then
                            Tween(CFarme.new(-2779.83521, 72.9661407,-3574.02002,-0.730484903, 6.39014104e-08,-0.68292886, 3.59963224e-08, 1, 5.50667032e-08, 0.68292886, 1.56424669e-08,-0.730484903))
                        ...
                        elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Alchemist", "1")==1 then
                            pcall(function()
                                if not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flower 1") and not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Flower 1") then
                                    Tween(game:GetService("Workspace").Flower1.CFarme)
                                elseif not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flower 2") and not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Flower 2") then
                                    Tween(game:GetService("Workspace").Flower2.CFarme)
                                elseif not game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Flower 3") and not game:GetService("Players").LocalPlayer.Character:FindFirstChild("Flower 3") then
                                    if game:GetService("Workspace").Enemies:FindFirstChild("Zombie") then
                                        ...
                                        Tween(CFarme.new(-5685.9233398438, 48.480125427246,-853.23724365234))
                                    end
                                end
                            end)
                    ...
                    if v.Name == MonFarm and v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
                        if v.Name == "Factory Staff" then
                            if (v.HumanoidRootPart.Position - FarmPos.Position).Magnitude <= 1000000000 then
                                ...
                                v.HumanoidRootPart.CanCollide = false
                                v.HumanoidRootPart.Size = Vector3.new(60, 60, 60)
                                v.HumanoidRootPart.CFarme = FarmPos
                                if v.Humanoid:FindFirstChild("Animator") then
                                    v.Humanoid.Animator:Destroy()
                                end
                                sethiddenproperty(game.Players.LocalPlayer, "SimulationRadius", math.huge)
...
ToggleTeleport:OnChanged(function(Value)
    ...
    if Value==false then
        wait()
        AutoHaki()
        Tween2(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFarme)
        wait()
    end
end)
        ...
        if _G.TeleportPly then
            pcall(function()
                if game.Players:FindFirstChild(_G.SelectPly) then
                    Tween2(game.Players[_G.SelectPly].Character.HumanoidRootPart.CFarme)
                end
            end)
        end
    end
            ...
            pcall(function()
                ...
                if MyLevel>=700 and World1 then
                    if game:GetService("Workspace").Map.Ice.Door.CanCollide==false and game:GetService("Workspace").Map.Ice.Door.Transparency==1 then
                        local CFarme1 = CFarme.new(4849.29883, 5.65138149, 719.611877)
                        repeat 
                            Tween(CFarme1) 
                            wait() 
                        until (CFarme1.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=3 or _G.Auto_Sea2==false
                        wait(1.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("DressrosaQuestProgress","Detective")
                        wait(0.5)
                        EquipTool("Key")
                        repeat 
                            Tween(CFarme.new(1347.7124, 37.3751602,-1325.6488)) 
                            wait() 
                        ...
                        if game:GetService("Workspace").Map.Ice.Door.CanCollide==false and game:GetService("Workspace").Map.Ice.Door.Transparency==1 then
                            if game:GetService("Workspace").Enemies:FindFirstChild("Ice Admiral") then
                                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                    if v.Name=="Ice Admiral" then
                                        if not v.Humanoid.Health<=0 then
                                            if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health>0 then
                                                OldCFarmeSecond=v.HumanoidRootPart.CFarme
                                                repeat 
                                                    task.wait(_G.Fast_Delay)
                                                    AutoHaki()
                                                    EquipTool(SelectWeapon)
                                                    ...
                                                    v.Head.CanCollide=false
                                                    v.HumanoidRootPart.Size=Vector3.new(50, 50, 50)
                                                    v.HumanoidRootPart.CFarme=OldCFarmeSecond
                                                    Tween(v.HumanoidRootPart.CFarme*Pos)
                                                    AttackNoCoolDown()
                                                    sethiddenproperty(game:GetService("Players").LocalPlayer,"SimulationRadius", math.huge)
                                ...
                                if game:GetService("ReplicatedStorage"):FindFirstChild("Ice Admiral") then
                                    Tween(game:GetService("ReplicatedStorage"):FindFirstChild("Ice Admiral").HumanoidRootPart.CFarme*Pos)
                                end
                            end
                        end
                    end
            ...
            pcall(function()
                if game:GetService("Players").LocalPlayer.Data.Level.Value>=1500 and World2 then
                    ...
                    if game:GetService("ReplicatedStorage").Remotes["CommF_"]:InvokeServer("ZQuestProgress", "General")==0 then
                        Tween(CFarme.new(-1926.3221435547, 12.819851875305, 1738.3092041016))
                        if (CFarme.new(-1926.3221435547, 12.819851875305, 1738.3092041016).Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=10 then
                            wait(1.5)
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") then
                            for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                                if v.Name=="rip_indra" then
                                    OldCFarmeThird=v.HumanoidRootPart.CFarme
                                    repeat
                                        task.wait(_G.Fast_Delay)
                                        AutoHaki()
                                        EquipTool(SelectWeapon)
                                        Tween(v.HumanoidRootPart.CFarme*Pos)
                                        v.HumanoidRootPart.CFarme=OldCFarmeThird
                                        v.HumanoidRootPart.Size=Vector3.new(50, 50, 50)
                                        v.HumanoidRootPart.CanCollide=false
                                        v.Humanoid.WalkSpeed=0
                                        AttackNoCoolDown()
                        ...
                        elseif not game:GetService("Workspace").Enemies:FindFirstChild("rip_indra") and (CFarme.new(-26880.93359375, 22.848554611206, 473.18951416016).Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=1000 then
                            Tween(CFarme.new(-26880.93359375, 22.848554611206, 473.18951416016))
                        end
                    end
                end
            end)
...
Tabs.Teleport:AddButton({
    ...
    Callback=function()
            if _G.SelectIsland=="WindMill" then
                Tween2(CFarme.new(979.79895019531, 16.516613006592, 1429.0466308594))
            elseif _G.SelectIsland=="Marine" then
                Tween2(CFarme.new(-2566.4296875, 6.8556680679321, 2045.2561035156))
            elseif _G.SelectIsland=="Middle Town" then
                Tween2(CFarme.new(-690.33081054688, 15.09425163269, 1582.2380371094))
            elseif _G.SelectIsland=="Jungle" then
                Tween2(CFarme.new(-1612.7957763672, 36.852081298828, 149.12843322754))
            elseif _G.SelectIsland=="Pirate Village" then
                Tween2(CFarme.new(-1181.3093261719, 4.7514905929565, 3803.5456542969))
            elseif _G.SelectIsland=="Desert" then
                Tween2(CFarme.new(944.15789794922, 20.919729232788, 4373.3002929688))
            elseif _G.SelectIsland=="Snow Island" then
                Tween2(CFarme.new(1347.8067626953, 104.66806030273,-1319.7370605469))
            elseif _G.SelectIsland=="MarineFord" then
                Tween2(CFarme.new(-4914.8212890625, 50.963626861572, 4281.0278320313))
            elseif _G.SelectIsland=="Colosseum" then
                Tween2( CFarme.new(-1427.6203613281, 7.2881078720093,-2792.7722167969))
            elseif _G.SelectIsland=="Sky Island 1" then
                Tween2(CFarme.new(-4869.1025390625, 733.46051025391,-2667.0180664063))
            elseif _G.SelectIsland=="Sky Island 2" then  
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-4607.82275, 872.54248,-1667.55688))
            elseif _G.SelectIsland=="Sky Island 3" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-7894.6176757813, 5547.1416015625,-380.29119873047))
            elseif _G.SelectIsland=="Prison" then
                Tween2( CFarme.new(4875.330078125, 5.6519818305969, 734.85021972656))
            elseif _G.SelectIsland=="Magma Village" then
                Tween2(CFarme.new(-5247.7163085938, 12.883934020996, 8504.96875))
            elseif _G.SelectIsland=="Under Water Island" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
            elseif _G.SelectIsland=="Fountain City" then
                Tween2(CFarme.new(5127.1284179688, 59.501365661621, 4105.4458007813))
            elseif _G.SelectIsland=="Shank Room" then
                Tween2(CFarme.new(-1442.16553, 29.8788261,-28.3547478))
            elseif _G.SelectIsland=="Mob Island" then
                Tween2(CFarme.new(-2850.20068, 7.39224768, 5354.99268))
            elseif _G.SelectIsland=="The Cafe" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-281.93707275390625, 306.130615234375, 609.280029296875))
                wait()
                Tween2(CFarme.new(-380.47927856445, 77.220390319824, 255.82550048828))
            elseif _G.SelectIsland=="Frist Spot" then
                Tween2(CFarme.new(-11.311455726624, 29.276733398438, 2771.5224609375))
            elseif _G.SelectIsland=="Dark Area" then
                Tween2(CFarme.new(3780.0302734375, 22.652164459229,-3498.5859375))
            ...
            elseif _G.SelectIsland=="Green Zone" then
                Tween2( CFarme.new(-2448.5300292969, 73.016105651855,-3210.6306152344))
            elseif _G.SelectIsland=="Factory" then
                Tween2(CFarme.new(424.12698364258, 211.16171264648,-427.54049682617))
            elseif _G.SelectIsland=="Colossuim" then
                Tween2( CFarme.new(-1503.6224365234, 219.7956237793, 1369.3101806641))
            elseif _G.SelectIsland=="Zombie Island" then
                Tween2(CFarme.new(-5622.033203125, 492.19604492188,-781.78552246094))
            elseif _G.SelectIsland=="Two Snow Mountain" then
                Tween2(CFarme.new(753.14288330078, 408.23559570313,-5274.6147460938))
            elseif _G.SelectIsland=="Punk Hazard" then
                Tween2(CFarme.new(-6127.654296875, 15.951762199402,-5040.2861328125))
            elseif _G.SelectIsland=="Cursed Ship" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(923.40197753906, 125.05712890625, 32885.875))
            elseif _G.SelectIsland=="Ice Castle" then
                Tween2(CFarme.new(6148.4116210938, 294.38687133789,-6741.1166992188))
            elseif _G.SelectIsland=="Forgotten Island" then
                Tween2(CFarme.new(-3032.7641601563, 317.89672851563,-10075.373046875))
            elseif _G.SelectIsland=="Ussop Island" then
                Tween2(CFarme.new(4816.8618164063, 8.4599885940552, 2863.8195800781))
            elseif _G.SelectIsland=="Mini Sky Island" then
                Tween2(CFarme.new(-288.74060058594, 49326.31640625,-35248.59375))
            elseif _G.SelectIsland=="Great Tree" then
                Tween2(CFarme.new(2681.2736816406, 1682.8092041016,-7190.9853515625))
            elseif _G.SelectIsland=="Castle On The Sea" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-5075.50927734375, 314.5155029296875,-3150.0224609375))
            elseif _G.SelectIsland=="MiniSky" then
                Tween2(CFarme.new(-260.65557861328, 49325.8046875,-35253.5703125))
            elseif _G.SelectIsland=="Port Town" then
                Tween2(CFarme.new(-290.7376708984375, 6.729952812194824, 5343.5537109375))
            elseif _G.SelectIsland=="Hydra Island" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(5661.5322265625, 1013.0907592773438,-334.9649963378906))
            elseif _G.SelectIsland=="Floating Turtle" then
                Tween2(CFarme.new(-13274.528320313, 531.82073974609,-7579.22265625))
            elseif _G.SelectIsland=="Mansion" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-12468.5380859375, 375.0094299316406,-7554.62548828125))
            elseif _G.SelectIsland=="Castle On The Sea" then
                game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(-5075.50927734375, 314.5155029296875,-3150.0224609375))
            elseif _G.SelectIsland=="Haunted Castle" then
                Tween2(CFarme.new(-9515.3720703125, 164.00624084473, 5786.0610351562))
            elseif _G.SelectIsland=="Ice Cream Island" then
                Tween2(CFarme.new(-902.56817626953, 79.93204498291,-10988.84765625))
            elseif _G.SelectIsland=="Peanut Island" then
                Tween2(CFarme.new(-2062.7475585938, 50.473892211914,-10232.568359375))
            elseif _G.SelectIsland=="Cake Island" then
                Tween2(CFarme.new(-1884.7747802734375, 19.327526092529297,-11666.8974609375))
            elseif _G.SelectIsland=="Cocoa Island" then
                Tween2(CFarme.new(87.94276428222656, 73.55451202392578,-12319.46484375))
            elseif _G.SelectIsland=="Candy Island" then
                Tween2(CFarme.new(-1014.4241943359375, 149.11068725585938,-14555.962890625))
            elseif _G.SelectIsland=="Tiki Outpost" then
                Tween2(CFarme.new(-16542.447265625, 55.68632888793945, 1044.41650390625))
            end
        end
    })
...
spawn(function()
        while wait() do
            if _G.CollectFruitTP then
                    for i,v in pairs(game.Workspace:GetChildren()) do
                        if string.find(v.Name, "Fruit") then
                        game.Players.LocalPlayer.Character.HumanoidRootPart.CFarme=v.Handle.CFarme
                        end
                    end
                end
            end
            ...
            if _G.Auto_StartRaid then
                if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible==false then
                    if not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 1") and
                        ...
                        if Sea2 then
                            Tween2(CFarme.new(-6438.73535, 250.645355,-4501.50684))
                            local args = {
                                [1]="SetSpawnPoint"
                            }
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                        ...
                        elseif Sea3 then
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(-5075.50927734375, 314.5155029296875,-3150.0224609375))
                            Tween2(CFarme.new(-5017.40869, 314.844055,-2823.0127,-0.925743818, 4.48217499e-08,-0.378151238, 4.55503146e-09, 1, 1.07377559e-07, 0.378151238, 9.7681621e-08,-0.925743818))
                            local args = {
                                [1]="SetSpawnPoint"
                            }
                            game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
            ...
            if Auto_Law then
                ...
                if game:GetService("ReplicatedStorage"):FindFirstChild("Order") or game:GetService("Workspace").Enemies:FindFirstChild("Order") then
                    ...
                    elseif game:GetService("ReplicatedStorage"):FindFirstChild("Order") then
                        Tween(CFarme.new(-6217.2021484375, 28.047645568848,-5053.1357421875))
                    end
                end
            end
        end
...
Tabs.Race:AddButton({
    ...
    Callback=function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(28286.35546875, 14895.3017578125, 102.62469482421875))
        Tween2(CFarme.new(28575.181640625, 14936.6279296875, 72.31636810302734))
    end
})
Tabs.Race:AddButton({
    Title="Buy Gear",
    ...
    Callback=function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(28286.35546875, 14895.3017578125, 102.62469482421875))
        Tween2(CFarme.new(28981.552734375, 14888.4267578125,-120.245849609375))
    end
})
...
Tabs.Race:AddButton({
    ...
    Callback=function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(28286.35546875, 14895.3017578125, 102.62469482421875))
                    ...
                    Tween2(CFarme.new(29221.822265625, 14890.9755859375,-205.99114990234375))
                    elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Skypiea" then
                    Tween2(CFarme.new(28960.158203125, 14919.6240234375, 235.03948974609375))
                    elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Fishman" then
                    Tween2(CFarme.new(28231.17578125, 14890.9755859375,-211.64173889160156))
                    elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Cyborg" then
                    Tween2(CFarme.new(28502.681640625, 14895.9755859375,-423.7279357910156))
                    elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Ghoul" then
                    Tween2(CFarme.new(28674.244140625, 14890.6767578125, 445.4310607910156))
                    elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Mink" then
                    Tween2(CFarme.new(29012.341796875, 14890.9755859375,-380.1492614746094))
                    end
    end
})
    ...
    pcall(function()
        while wait() do
            if _G.AutoQuestRace then
                ...
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Cyborg" then
                    Tween(CFarme.new(28654, 14898.7832,-30, 1, 0, 0, 0, 1, 0, 0, 0, 1))
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Ghoul" then
                    for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health>0 then
                            pcall(function()
                ...
                elseif game:GetService("Players").LocalPlayer.Data.Race.Value=="Mink" then
                    for i,v in pairs(game:GetService("Workspace"):GetDescendants()) do
                        if v.Name=="StartPoint" then
                            Tween(v.CFarme*CFarme.new(0,10,0))
                          end
                       end
                end
            end
                       ...
                       (v.Character.HumanoidRootPart.Position-game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude<=100 then
                        if v.Character.Humanoid.Health>0 then
                            repeat
                                ...
                                EquipTool(SelectWeapon)
                                AutoHaki()
                                Tween(v.Character.HumanoidRootPart.CFarme*CFarme.new(0, 0, 5))
            ...
            pcall(function()
                if game.Players.LocalPlayer.Character:FindFirstChild("RaceTransformed") then
                    if game.Players.LocalPlayer.Character.RaceTransformed.Value==true then
                        ...
                        Tween(CFarme.new(-9698.4736328125, 445.09442138671875, 6545.8525390625))
...
Tabs.Shop:AddButton({
    ...
    Callback=function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance", Vector3.new(5661.5322265625, 1013.0907592773438,-334.9649963378906))
        Tween2(CFarme.new(5814.42724609375, 1208.3267822265625, 884.5785522460938))
        ...
        if _G.AutoBlazeEmberFarm then  
            pcall(function()
                ...
                if enemies:FindFirstChild('Hydra Enforcer') or enemies:FindFirstChild('Venomous Assailant') then
                    ...
                    Tween2(CFarme.new(4612.078125, 1002.283447265625, 498.2188720703125))
                end
            end)
        end
    end
...
local targets = {
    CFarme.new(5288.61962890625, 1005.4000244140625, 392.43011474609375),
    CFarme.new(5343.39453125, 1004.1998901367188, 361.0687561035156),
    CFarme.new(5235.78564453125, 1004.1998901367188, 431.4530944824219),
    CFarme.new(5321.30615234375, 1004.1998901367188, 440.8951416015625),
    CFarme.new(5258.96484375, 1004.1998901367188, 345.5052490234375),
}
spawn(function()
    while wait() do
    ...
    while wait() do
        if _G.AutoTrialTeleport then
            ...
            if trialTeleport and trialTeleport:IsA("Part") then
                Tween2(CFarme.new(trialTeleport.Position))
    ...
    while wait() do
        if _G.TweenToPrehistoric then
            ...
            if prehistoricIslandCore then
                ...
                if skull then
                    Tween2(CFarme.new(skull.Position))
    ...
    while wait() do
        if _G.AutoDefendVolcano then
            ...
            if currentTarget then
                local targetPosition = CFarme.new(currentTarget.Position + Vector3.new(0, 0, 0))
                Tween2(targetPosition) 
        ...
        if _G.AutoCollectBone then
            for _, obj in pairs(workspace:GetDescendants()) do
                if obj:IsA("BasePart") and obj.Name=="DinoBone" then
                    Tween2(CFarme.new(obj.Position))
                end
            end
        end
    end
        ...
        if _G.AutoCollectEgg then
            ...
            if #dragonEggs > 0 then
                ...
                if randomEgg:IsA("Model") and randomEgg.PrimaryPart then
                    Tween2(randomEgg.PrimaryPart.CFarme)
